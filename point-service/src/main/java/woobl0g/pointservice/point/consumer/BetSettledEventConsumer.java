...
import woobl0g.pointservice.point.event.BetSettledEvent;
import woobl0g.pointservice.point.service.PointService;

@Slf4j
@Component
@RequiredArgsConstructor
public class BetSettledEventConsumer {
    ...
    public void consume(String message) {
        log.debug("베팅 정산 이벤트 수신: message={}", message);
        ...
        log.info("베팅 정산 포인트 적립 완료: userId={}", addPointRequestDto.getUserId());
    }
}
